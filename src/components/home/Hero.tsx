      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <p className="text-xl mb-8 text-white/80 max-w-lg animate-fade-in" style={{animationDelay: "0.2s"}}>
              Formando profesionales de la educación con valores cristianos desde 1959. Comprometidos con la excelencia académica y el desarrollo integral.
            </p>
